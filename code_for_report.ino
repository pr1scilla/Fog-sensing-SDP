...
/*threshold values determined by user*/
int h = 85;         // h is the threshold humidity determined by user. 
                    // h is set to be 85(%) by defult. 85% humidity is determined by
...
float v = 1000;     // v is the threshold visibility determined by user. 
                    ...
                    // Professor Peter Weiss
/*buffer time setup*/
int buffertime = 1800000;    //set up the buffer time in ms scale.
                            // For example, if you want the buffer time to be 30 seconds, 
                            //then set buffertime = 30*1000=30000;
